...
class MissileTest {
    ...
    void move_increasesYOnly() {
        Missile missile = new Missile(100, 100, 260, 600, 2);
    ...
    void shouldExplode_atExplosionY_returnsTrue() {
        Missile missile = new Missile(100, 600, 260, 600,2);
    ...
    void update_reachesExplosionY_startsExploding() {
        Missile missile = new Missile(100, 500, 260, 600,2);
    ...
    void collidesWith_overlappingPlane_returnsTrue() {
        Missile missile = new Missile(125, 125, 260, 600,2);
